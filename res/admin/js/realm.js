...
if($('#forms_page').length > 0 ){
  ...
  var editor = new TINY.editor.edit('editor', {
    ...
    controls: ['bold', 'italic', 'underline', 'strikethrough', '|', 'subscript', 'superscript', '|', 'orderedlist', 'unorderedlist', '|', 'leftalign', 'centeralign', 'rightalign', 'blockjustify', '|', 'unformat', 'hr', '|', 'undo', 'redo', 'n', 'font', 'size'],
    footer: true,
  ...
  $("#country-select2-basic").select2();
  $("#lang-select2-basic").select2();
  $("#date-country-select2-basic").select2();
  $("#director-select2-basic").select2();
  
  $("#select2-multi-value").select2();
  $(".writers-select2-max-value").select2({maximumSelectionSize: 1});
  // $(".casts-select2-max-value").select2({maximumSelectionSize: 1});
  $(".casts-select2-max-value").select2();
