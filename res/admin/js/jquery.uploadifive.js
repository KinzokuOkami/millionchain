        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                var settings = $data.settings = $.extend({
                    ...
                    'buttonText'      : 'Choose a File',     // The text that appears on the UploadiFive button
                ...
                $data.inputTemplate = $('<input class="c-file" type="file">')
                .css({
                    'opacity'   : 0,
                    'position'  : 'absolute',
                    'right'     : '0',
                ...
                if (settings.itemTemplate == false) {
                    $data.queueItem = $('<div class="uploadifive-queue-item">\
                        ...
                        <div style="margin:0 0 10px 0;"><span class="filename"></span><span class="fileinfo"></span></div>\
                        <div class="progress">\
                ...
                $data.checkExists = function(file) {
                    if ($.inArray('onCheck', settings.overrideEvents) < 0) {
                        ...
                        if (file.exists) {
                            ...
                            if (!confirm('Are you sure you want to overwrite current picture?')) {
